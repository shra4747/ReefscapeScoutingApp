...
const AdminCons = () => {
  ...
  const getMaxMatchNumber = async () => {
    try {
      ...
      const scheduleResponse = await fetch(`http://10.75.65.142:5002/schedule`, {
        method: 'GET',
        headers: {
      ...
      const robotsResponse = await fetch(`http://10.75.65.142:5002/robots_in_match`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${access_token}`,
          'Content-Type': 'application/json',
  ...
  const uploadSchedule = async (tournamentLevel = 'qualification') => {
    ...
    try {
      ...
      // Post schedule data
      const postResponse = await fetch(`http://10.75.65.142:5002/schedule`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${access_token}`,
          'Content-Type': 'application/json',
        ...
        { 
          ...
          onPress: async () => {
            try {
              ...
              const response = await fetch("http://10.75.65.142:5002/clear_tables", {
                method: 'GET',
                headers: {
                  'Authorization': `Bearer ${access_token}`,
                  'Content-Type': 'application/json',
